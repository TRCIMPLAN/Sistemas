<?php
/**
 * TrcIMPLAN Central - SMILanzaderaPorCategorias MatrizPHP
 *
 ...
 * Clase MatrizPHP
 */
class MatrizPHP extends Matriz {
    ...
    public function php() {
        ...
        if (!$this->consultado) {
            throw new \Exception("Error en MatrizPHP: No se ha consultado.");
        }
        // Acumularemos la entrega en este arreglo
        $a = array();
        // Acumular
        $a[] = '<h3>Zona Metropolitana de La Laguna</h3>';
