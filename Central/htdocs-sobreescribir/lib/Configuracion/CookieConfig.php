<?php
/**
 * TrcIMPLAN Central - CookieConfig
 *
...
abstract class CookieConfig {
    ...
    protected $nom_cookie     = 'trcimplan_central'; // DEBE DEFINIR el nombre con el que se guardara la cookie en el navegador.
    ...
    protected $key            = 'Camb1eAUnaD1f1c1l'; // 16 caracteres o más que sean muy difíciles de adivinar para llave de cifrado
