...
<?php
/**
 * TrcIMPLAN Central - Probar SIG Ficha TXT
 *
...
function ayuda() {
    echo "\n";
    echo "Objetivo:\n";
    echo "  Mostrará los datos usados para crear un publicación de un mapa SIG.\n";
    echo "\n";
    echo "Sintaxis:\n";
    echo "  ProbarSIGFichaTXT.php <ID Mapa>\n";
    echo "\n";
}
...
// Proceso principal
$ficha_txt = new \SigLanzadera\FichaTXT($sesion);
try {
