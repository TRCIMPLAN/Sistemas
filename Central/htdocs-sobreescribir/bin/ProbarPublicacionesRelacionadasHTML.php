...
// Soy
$soy = '[Probar Publicaciones Relacionadas HTML]';
...
function ayuda() {
    ...
    echo "\n";
    echo "Sintaxis:\n";
    echo "  ProbarPublicacionesRelacionadasHTML.php <ID Vínculo>\n";
    echo "\n";
}
...
$publicaciones_relacionadas_html = new \OrgVinculos\PublicacionesRelacionadasHTML($sesion);
try {
    $publicaciones_relacionadas_html->consultar_vinculo($argv[1]);
    echo $publicaciones_relacionadas_html->html()."\n";
} catch (\Exception $e) {
    echo $publicaciones_relacionadas_html->mensajes."\n";
