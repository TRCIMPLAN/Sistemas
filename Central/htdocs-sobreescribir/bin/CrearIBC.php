...
function ayuda() {
    echo "\n";
    echo "Objetivo:\n";
    echo "  Crear los archivos con las publicaciones de los Indicadores Básicos por Colonia (IBC).\n";
    echo "  Ejecutará \\IBCLanzadera\\PublicadorIBC\n";
    echo "\n";
    echo "Sintaxis:\n";
    echo "  CrearIBC.php\n";
    echo "\n";
...
// Publicar
echo "$soy Inicia\n";
$publicador = new \IBCLanzadera\PublicadorIBC($sesion);
try {
